...
public class CcsClient {
    ...
    public static void main(String[] args) {
	    ...
	    final String projectId = "210193935586";
	    final String password = "AIzaSyCpD3xB2zHM3YuFwstOLm43zEHrwvkRW_Q";
	    ...
	    //TODO: messageidhandling needed here
	    String messageId = ccsClient.getRandomMessageId();
	    //data: The payload of the app
        Map<String, String> payload = new HashMap<String, String>();
        payload.put("message", "Simple sample sessage");
	    // A key indicating that only the last message of this type should be sent to a device when it comes online again
	    String collapseKey = "sample!";
	    // 	The amount of time for which Google should keep the message around if the device is offline. The default is four weeks.
	    Long timeToLive = 10000L;
	    // A flag indicating that messages should be kept on Google’s server if the device is inactive
	    ...
	    // Send a visit downstream message to a device.
	    //toRegId = "APA91bEPjC9VKg5vNgoZuqfxVUAXQh-Zeu7-LVOR3OPLHT3QFFAQsXGfVBlbhUWv6tuDtNXOBsK5DselVGVuzV378BmDZsyOUWS5Jya_SxqDafbphxOKRlG2Wqa7wsfN5Y1TY8w8n-wRglSoOXT8mlK2oET9ibPP-03XFtiH8pwM1cw0D7w7EDc";
	    messageId = ccsClient.getRandomMessageId();
	    payload = new HashMap<String, String>();
	    payload.put("visit", "This is a visit, take it or leave it! Date: 20.05.2014. Greetings from the server.");
	    collapseKey = null; //TODO: does this work? remove, not needed, we need all messages!
	    timeToLive = 10000L; // The default currently is four weeks.
	    delayWhileIdle = true;
	    ccsClient.send(createJsonMessage(toRegId, messageId, payload, collapseKey, timeToLive, delayWhileIdle));

	    // Send a recommendation downstream message to a device.
	    //toRegId = "APA91bEPjC9VKg5vNgoZuqfxVUAXQh-Zeu7-LVOR3OPLHT3QFFAQsXGfVBlbhUWv6tuDtNXOBsK5DselVGVuzV378BmDZsyOUWS5Jya_SxqDafbphxOKRlG2Wqa7wsfN5Y1TY8w8n-wRglSoOXT8mlK2oET9ibPP-03XFtiH8pwM1cw0D7w7EDc";
	    messageId = ccsClient.getRandomMessageId();
	    payload = new HashMap<String, String>();
	    payload.put("recommendation", "This is a recommendation, it says lorem ipsum sit dolor and you should take that for real. Greetings from the server.");
	    collapseKey = null;
	    timeToLive = 10000L;
	    delayWhileIdle = true;
	    ccsClient.send(createJsonMessage(toRegId, messageId, payload, collapseKey, timeToLive, delayWhileIdle));
	    ...
	    messageId = ccsClient.getRandomMessageId();
	    payload = new HashMap<String, String>();
	    payload.put("pregnancy", "This is some info about your facility and so on.");
	    collapseKey = null;
	    timeToLive = 10000L; // 10 months! TODO
	    delayWhileIdle = true;
	    ccsClient.send(createJsonMessage(toRegId, messageId, payload, collapseKey, timeToLive, delayWhileIdle));
    }
}