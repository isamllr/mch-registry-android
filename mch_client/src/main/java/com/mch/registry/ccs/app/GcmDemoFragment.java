...
public class GcmDemoFragment extends DemoBaseFragment implements View.OnClickListener {
   ...
   public void onClick(View view) {
      ...
      if (view.getId() == R.id.btn_register) {
         ...
         case UNREGISTERED:
            ...
            break;
         default:
            Log.e("PregnancyGuide", "click event on register button while it should be deactiviated");
            break;
         }
